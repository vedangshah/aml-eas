...
<html lang="en">
	<head>
		...
		<link href="http://ajax.googleapis.com/ajax/libs/jqueryui/1.10.4/jquery-ui.min.js"  rel="stylesheet">
		<!--Material Icons-->
	...
	<script>
		   $(document).ready(function(){
               ...
               $("#jobseeker-birth-date").datepicker();
		   });
		</script>
								...
								<div class="card-body ">
									<div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control" required id="jobseeker-name" name="jobseeker-name" placeholder="Jobseeker Name" tabindex="1" autofocus>                                       </div>
										<div class="form-group col-md-6">
											<label for="jobseeker-email">E-mail</label>
                                            <input type="email" class="form-control" required id="jobseeker-email" name="jobseeker-email" placeholder="Jobseeker-Email" tabindex="2" autofocus>
										</div>
									</div>
                                    <div class="form-row">
										<div class="form-group col-md-6">
											<label for="jobseeker-contact-no">Contact No</label>
											<input type="text" class="form-control" required id="jobseeker-contact-no" name="jobseeker-contact-no" placeholder="Jobseeker-Contact-No" tabindex="3" autofocus>
										</div>
										<div class="form-group col-md-6">
											<label for="jobseeker-birth-date">Date-of-Birth</label>
                                            <input type="text"  class="form-control" required id="jobseeker-birth-date" name="jobseeker-birth-date" placeholder="Jobseeker-Birth-Date" tabindex="4" autofocus>
                                          </div>
                                    ...
                                    <div class="form-row">
										<div class="form-group col-md-6">
											...
											<input type="text" class="form-control" required id="company-name" name="company-name" placeholder="company-Name" tabindex="5" autofocus>										</div>
										<div class="form-group col-md-6">
											<label for="jobseeker-password">Password</label>
                                            <input type="password" class="form-control" required id="jobseeker-password" name="jobseeker-password" placeholder="Password" tabindex="6" autofocus>                                     </div>
                                    ...
                                    <div class="form-row">      
										<div class="form-group col-md-6">
                                            ...
                                            <textarea class="form-control" required id="jobseeker-address" name="jobseeker-address" tabindex="7" autofocus>
                                            </textarea>
                                          </div>
									...
									<div class="form-group col-md-6 mt-5">
                                        ...
                                        <div class="custom-file">
                                           <input type="file" class="custom-file-input " required name="" tabindex="8">
									...
									<div class="form-group">
										<button class="btn btn-dark" tabindex="9">Submit</button>
									</div>
								</div>
							</div>
							<!--widget card ends-->
